						...
						<table class="table table-bordered" id="dataTable">
							...
							<tbody>
								...
								<tr>
									...
									<td><%=resultSet.getString("makale_tarih")%></td>
									<td><%=resultSet.getString("makaler_yazari")%></td>
									<td><%=resultSet.getString("makale_ilgiAlani")%></td>
									<td><%=resultSet.getString("makale_resim")%></td>
									<td><a href="makale_islemleri.jsp?id=<%=resultSet.getString("id")%>">İncele</a></td>
									<td><a href="AdminPaneli/beklenen_makale_delete.jsp?id=<%=resultSet.getString("id")%>">Delete</a></td>
								</tr>
								<%
									}
										connection.close();
